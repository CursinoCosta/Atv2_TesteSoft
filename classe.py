...
# --- Classes Auxiliares para Testar o Framework ---
...
# ... (Mantenha as classes TestResult, TestCase, TestSuite, TestStub, TestSpy, TestCaseTest e TestSuiteTest que já criamos) ...
...
# --- Testes do Framework (Adicione junto aos outros) ---
...
# --- Novo bloco de execução final ---

# ... (Mantenha todas as classes anteriores intactas) ...
